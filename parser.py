...
def parse_file( fname, edges, transform, screen, color ):
    ...
    while c < len(lines):
        ...
        #circle
            ...
            #adds a circle that takes 4 parameters (cx, cy, cz, r)
            add_circle(edges, float(args[0]), float(args[1])), float(args[2]), float(args[3]), 0.001)
        #hermite
        elif line == 'hermite':
            #adds a hermite curve with 8 parameters (x0, y0, x1, y1, rx0, ry0, rx1, ry1)
        ...
        #bezier
            ...
            #adds a bezier curve that takes 8 parameters (x0, y0, x1, y1, x2, y2, x3, y3)
